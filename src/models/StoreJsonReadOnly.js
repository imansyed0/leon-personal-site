...
class StoreJsonReadOnly {
  ...
  save (url, data) {
    // In read-only mode, we don't try to write to the filesystem
    console.log(`[ReadOnly Mode] Would have saved data to: ${STORAGE_DIRNAME}/${url.split('/').join('__')}.json`)
    return Promise.resolve()
  }
...
export default StoreJsonReadOnly 